...
<h2 class="impact" style="color:whitesmoke;"><b>Category Master Delete</b></h2>
    ...
    if(mysql_num_rows($result)>0)
    {
      //  echo "<table border='1'>
       ...
       // </tr>";
        ...
        {
            echo "<tr>";
            echo "<td><center><a href=\"catDeleteDetails.php?id={$row['category_code']}\">".$row['category_code']."</a></td>";
        
            echo "<td><center>".$row['category_name']."</td>";            
