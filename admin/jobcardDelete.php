...
<h2 class="impact" style="color:whitesmoke;"><b>Jobcard Delete</b></h2>
...
if($con)
{
    ...
    if(mysql_num_rows($result)>0)
    {
      /*  echo "<table border='1'>
        ...
        {
            echo "<tr>";
            echo "<td><a href=\"jobcardDeleteDetails.php?id={$row['JobCard_No']}\">".$row['JobCard_No']."</a></td>";
            ...
            echo "<td>".$row['JobCard_Date']."</td>";
            echo "<td>".$row['Fuel']."</td>";
            echo "<td>".$row['Date_Time_In']."</td>";
            echo "<td>".$row['Date_Time_Out']."</td>";
            echo "<td>".$row['Job_Allocation']."</td>";
            echo "<td>".$row['Kms']."</td>";
            echo "<td>".$row['Complain_Id']."</td>";
            echo "<td>".$row['Complain_Des']."</td>";
            echo "<td>".$row['Bay_No']."</td>";
