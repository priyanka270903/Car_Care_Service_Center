...
<h2 class="impact" style="color:whitesmoke;"><b>Purchase Return Delete</b></h2>
 ...
 if($con)
 {
    ...
    if(mysql_num_rows($result)>0)
    {
      /*  echo "<table border='1'>
        ...
        {
            echo "<tr>";
            echo "<td><center><a href=\"purchasereturnDeleteDetails.php?id={$row['PurchaseReturnNo']}\">".$row['PurchaseReturnNo']."</a></td>";
            echo "<td><center>".$row['PurchaseReturnDate']."</td>";           
