...
<h2 class="impact" style="color:whitesmoke;"><b>Registration Delete</b></h2>
...
if($con)
{
    ...
    if(mysql_num_rows($result)>0)
    {
      /*  echo "<table border='1'>
        ...
        {
            echo "<tr>";
            echo "<td><center><a href=\"registrationDeleteDetails.php?id={$row['Username']}\">".$row['Username']."</a></td>";
