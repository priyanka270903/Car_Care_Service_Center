  ...
  if($con)
  {
    ...
    if(mysql_num_rows($result)>0)
    {
      /*  echo "<table border='1'>
        ...
        {
            echo "<tr>";
            echo "<td><center>".$row['Receipt_Code']."</a></td>";
