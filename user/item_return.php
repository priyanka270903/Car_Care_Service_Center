<?php
 if(isset($_POST['submit']))
 {
    ...
    if($con)
  {
    ...
    //echo $rid;
    $sql2 = "select IssueDate,Issue_Iname,Issue_Unit_Measure,Issue_Rate,Warranty_Year from item_issue where I_Code='$rid'";
      ...
      if(mysql_query($sql,$con))
{
    ...
    //$update="Update item_issue set Issue_Qty = Issue_Qty -  $Qty where I_No='$Return_Code'";
