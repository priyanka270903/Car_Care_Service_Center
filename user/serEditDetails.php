...
<h2 class="impact" style="color:whitesmoke;"><b>Service Master Edit</b></h2>
...
if($con)
{
    ...
    echo "<form action=\"serSaveDetails.php\" method=\"POST\">";
    
    echo"<tr>";
    echo "<p><td>Service Code<td><input type=\"text\" name=\"sercode\" value={$row['Service_Code']}></td></p>";
    echo"</tr>";
    
    echo"<tr>";
    echo "<p><td>Service Name<td><input type=\"text\" name=\"sername\" value={$row['Service_Name']}></td></p>";
    echo"</tr>";
    
    echo"<tr>";
    echo "<p><td>Service Type<td><input type=\"text\" name=\"sertype\" value={$row['Service_Type']}></td></p>";
    echo"</tr>";
    
    echo"<tr>";
    echo "<p><td>Service Charge<td><input type=\"text\" name=\"sercharge\" value={$row['Service_Charge']}></td></p>";
    echo"</tr>";
